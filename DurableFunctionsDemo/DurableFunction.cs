...
namespace DurableFunctionsDemo
{
    public static class DurableFunction
    {
        ...
        public static async Task<List<string>> RunOrchestrator( //creates the list and run the call then returns the list
        ...
        [Function(nameof(SayHello))] //activity function
        ...
        [Function("DurableFunction_HttpStart")] //function name that will start
